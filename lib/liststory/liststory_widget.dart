...
import 'liststory_model.dart';
export 'liststory_model.dart';

class ListstoryWidget extends StatefulWidget {
  const ListstoryWidget({Key? key}) : super(key: key);

  @override
  _ListstoryWidgetState createState() => _ListstoryWidgetState();
}

class _ListstoryWidgetState extends State<ListstoryWidget>
    with TickerProviderStateMixin {
  late ListstoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListstoryModel());
  }
                        ...
                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              child: Container(
                                                ...
                                                child: Image.network(
                                                  'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxN3x8cHJvZmlsZXxlbnwwfHx8fDE2OTgxNjYyMTh8MA&ixlib=rb-4.0.3&q=80&w=1080',
                                                  fit: BoxFit.cover,
                                                ),
                                              ),
                                            ),
                          ...
                          if (responsiveVisibility(
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 12.0, 0.0, 0.0),
                              child: FutureBuilder<List<HistoriasRow>>(
                                future: HistoriasTable().queryRows(
                                  queryFn: (q) => q,
                                ),
                                builder: (context, snapshot) {
                                  ...
                                  return ListView.separated(
                                    ...
                                    scrollDirection: Axis.vertical,
                                    itemCount:
                                        mobileViewHistoriasRowList.length,
                                    separatorBuilder: (_, __) =>
                                        SizedBox(height: 12.0),
                                    itemBuilder: (context, mobileViewIndex) {
                                      final mobileViewHistoriasRow =
                                          mobileViewHistoriasRowList[
                                              mobileViewIndex];
                                      return Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
