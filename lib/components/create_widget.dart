              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      wrapWithModel(
                        model: _model.uploadphotoprofileModel,
                        updateCallback: () => setState(() {}),
                        child: UploadphotoprofileWidget(),
                      ),
                      Padding(
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Conte sua primeira Historia ',
                            labelStyle:
                                FlutterFlowTheme.of(context).labelMedium,
                            hintStyle: FlutterFlowTheme.of(context).labelMedium,
                            enabledBorder: OutlineInputBorder(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await HistoriasTable().insert({
                                'titulo': _model.yourNameController1.text,
                                'conteudo': _model.yourNameController2.text,
                                'data_criacao': supaSerialize<DateTime>(
                                    getCurrentTimestamp),
                              });
                              context.pop();
